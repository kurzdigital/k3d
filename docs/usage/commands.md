...
k3d
  ...
  cluster [CLUSTERNAME]  # default cluster name is 'k3s-default'
    create
      ...
      --auto-gpu  # auto-detect host GPU vendor and apply matching --gpus/--device flags (string: 'auto'|'nvidia'|'amd'|'intel'|'none', default 'none')
    ...
    update-environment CLUSTER  # [EXPERIMENTAL] refresh cluster's view of the host (gateway, network members) without restart
